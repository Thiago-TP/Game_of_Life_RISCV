# 	Checks if a dead cell must live. The rules are:
...
update_dead_cell:
	...
	# if counter is 3*live_value, the dead center cell lives in the hidden frame
	li		t4, live_cell_value
	add		t4, t4, t4
	addi	t4, t4, live_cell_value
	beq		t3, t4, become_alive
